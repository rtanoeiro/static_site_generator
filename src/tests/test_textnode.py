...
class TestTextNode(unittest.TestCase):
    ...
    def test_text_node_to_html_node_bold_to_html(self):
        text_node = TextNode("This is a test bold text", TextType.BOLD)
    ...
    def test_text_node_to_html_node_italic_to_html(self):
        text_node = TextNode("This is a test italic text", TextType.ITALIC)
        html_node = text_node_to_html_node(text_node).to_html()
    ...
    def test_text_node_to_html_node_code_to_html(self):
        text_node = TextNode("This is a test code", TextType.CODE)
        html_node = text_node_to_html_node(text_node).to_html()
    ...
    def test_text_node_to_html_node_link_to_html(self):
    ...
    def test_text_node_to_html_node_image_to_html(self):
        text_node = TextNode(
